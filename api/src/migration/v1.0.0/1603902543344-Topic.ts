...
export class Topic1603902543344 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<any> {
    await queryRunner.query(
      `CREATE TABLE "topic" ("deleted_at" datetime2, "created_at" datetime2 CONSTRAINT "DF_65aca285a83e07f786ff24b6b2d" DEFAULT getdate(), "updated_at" datetime2 CONSTRAINT "DF_970a39a17772a43b3df88d60384" DEFAULT getdate(), "id" int NOT NULL IDENTITY(1,1), "creator_id" int NOT NULL, "subject" ntext NOT NULL, "description" ntext, "status" tinyint NOT NULL CONSTRAINT "DF_64636430227db1b94299318a230" DEFAULT 1, "approver_id" int NOT NULL, "thesis_id" int NOT NULL, CONSTRAINT "PK_33aa4ecb4e4f20aa0157ea7ef61" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "topic_state" ("deleted_at" datetime2, "created_at" datetime2 CONSTRAINT "DF_1429a80c8dacbf5743ec6088396" DEFAULT getdate(), "updated_at" datetime2 CONSTRAINT "DF_ec9a410f3669f5da7af5c1cbff6" DEFAULT getdate(), "id" int NOT NULL IDENTITY(1,1), "topic_id" int NOT NULL, "comment" ntext, "action" tinyint NOT NULL CONSTRAINT "DF_282f2c7ea7877873e6e6bde4176" DEFAULT 1, CONSTRAINT "PK_c787c9489bae28d5ac8361a64c0" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
