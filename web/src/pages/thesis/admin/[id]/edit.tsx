...
const Edit: NextPageWithLayout<PageProps> = ({ params }) => {
  ...
  const [thesis, setThesis] = useState<ThesisRequestBody | undefined>(undefined);
  ...
  return {
    props: {
      ...
      breadcrumbs: [
        ...
        { text: ThesisTerminology.THESIS_4, href: `${THESIS_PATH_ROOT}/${params && params.id}` },
