...
import { STUDENT_ADMIN_PATH_ROOT, StudentPath } from '../../../../libs/student/student.resource';
import { StudentForm, StudentRequestBody } from '../../../../libs/student/student.type';
...
const Edit: NextPageWithLayout<PageProps> = ({ params }) => {
  ...
  useEffect(() => {
    (async () => {
      let currentStudent: StudentRequestBody = {};
      try {
    ...
    props: {
      ...
      breadcrumbs: [
        { text: StudentTerminology.STUDENT_1, href: STUDENT_ADMIN_PATH_ROOT },
        {
          ...
          href: CommonService.getInstance().replaceParams(StudentPath.SPECIFY, [
