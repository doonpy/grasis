...
import { StudentSearchAttendee } from '../../libs/student/student.type';
...
const ThesisAttendeesSelectFormItem: React.FC<ComponentProps> = ({
  ...
  const [searchTypes, setSearchTypes] = useState<CheckboxValueType[]>([
  ...
  const onSearchTypeChange = (checkedValue: CheckboxValueType[]) => {
  ...
  const renderItem = ({ fullName, key, attendeeId }: TransferItem) => {
